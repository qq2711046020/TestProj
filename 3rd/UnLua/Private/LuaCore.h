...
void PushLazyObjectArray(lua_State *L, FLazyObjectProperty *Property, void *Value);//FIXED
void PushWeakObjectArray(lua_State *L, FWeakObjectProperty *Property, void *Value);//FIXED
/**
...
UNLUA_API int32 Global_Warn(lua_State* L);//FIXED
