 ...
 * Push a SoftObject
 */
static void PushSoftObjectElement(lua_State* L, FSoftObjectProperty* Property, void* Value)
{
    FSoftObjectPtr* SoftObjectPtr = Property->GetPropertyValuePtr(Value);
    void** Userdata = (void**)lua_newuserdata(L, sizeof(void*));
    *Userdata = SoftObjectPtr;
    MarkUserdataTwoLvlPtr(L, -1);
}
 ...
 * Push a LazyObject
 */
static void PushLazyObjectElement(lua_State* L, FLazyObjectProperty* Property, void* Value)
{
    FLazyObjectPtr* LazyObjectPtr = Property->GetPropertyValuePtr(Value);
    void** Userdata = (void**)lua_newuserdata(L, sizeof(void*));
    *Userdata = LazyObjectPtr;
    MarkUserdataTwoLvlPtr(L, -1);
}
 ...
 * Push a WeakObject
 */
static void PushWeakObjectElement(lua_State* L, FWeakObjectProperty* Property, void* Value)
{
    FWeakObjectPtr* WeakObjectPtr = Property->GetPropertyValuePtr(Value);
    void** Userdata = (void**)lua_newuserdata(L, sizeof(void*));
    *Userdata = WeakObjectPtr;
    MarkUserdataTwoLvlPtr(L, -1);
}
//END////////////////////////////////////////////////////////////////////////////////////////////////////////
...
void PushLazyObjectArray(lua_State *L, FLazyObjectProperty *Property, void *Value)
{
    PushPropertyArray<FLazyObjectProperty, true>(L, Property, Value, PushLazyObjectElement, "FLazyObjectPtr");
}

void PushWeakObjectArray(lua_State *L, FWeakObjectProperty *Property, void *Value)
{
    PushPropertyArray<FWeakObjectProperty, true>(L, Property, Value, PushWeakObjectElement, "FWeakObjectPtr");
}
//END/////////////////////////////////////////
/**
...
int32 Global_NewObject(lua_State *L)
{
...

    {
        ...
        if (Object)
        {
			/*if (GLuaCxt->CheckBindable(Object)) {
				GObjectReferencer.AddObjectRef(Object);
			}*/
